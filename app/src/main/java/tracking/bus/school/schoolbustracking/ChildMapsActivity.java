...
import tracking.bus.school.schoolbustracking.MapModules.DirectionFinder;
import tracking.bus.school.schoolbustracking.MapModules.DirectionFinderListener;
import tracking.bus.school.schoolbustracking.MapModules.Route;
...
import static tracking.bus.school.schoolbustracking.R.id.btnBack;
            ...
            public void onDataChange(DataSnapshot snapshot) {
                if (snapshot.hasChild("latitude")) {
                    ...
                    myRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot snapshot) {
                            if (snapshot.hasChild("latitude")) {
                                fromDriver = snapshot.child("latitude").getValue().toString() + "," + snapshot.child("longtitude").getValue().toString();
        ...
        if (locationManager.isProviderEnabled(LocationManager.NETWORK_PROVIDER)) {
            ...
            locationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 0, 0, new android.location.LocationListener() {
                ...
                public void onLocationChanged(Location location) {
                    ...
                    latitudeLongtitude.setLatitude(String.valueOf(latitude));
                    latitudeLongtitude.setLongtitude(String.valueOf(longtitude));
                    ref.child("DriverLocation").child(user.getUid()).setValue(latitudeLongtitude);
