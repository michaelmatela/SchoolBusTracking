                                            ...
                                            case DialogInterface.BUTTON_POSITIVE:
                                                ...
                                                if(driver.isEmpty()) {
                                                    if (Integer.parseInt(profile.getCapacity()) < (Integer.parseInt(children_count) + Integer.parseInt(profile.getCurrent()))) {
                                                        Toast.makeText(getActivity(), "Driver capacity is not enough for the count of child for this parent.", Toast.LENGTH_LONG).show();
                                                    } else {
                                                    ...
                                                    Toast.makeText(getActivity(), "A driver is already assigned to this account.", Toast.LENGTH_LONG).show();
                                                }
                                                break;
